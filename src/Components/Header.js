      ...
      <BottomWrapper>
        <Bd>
          ...
          <List onClick={onClientServiceCenterClick}>
            <BottomSvg xmlns="http://www.w3.org/2000/svg" pageMatch={isCSCPage} viewBox="0 0 512 512">
      ...
      <WebHeader>
        <Bundle>
          <Category pageMatch={isMainPage}>
            <Anchor onClick={onMainClick}>
              Home
            </Anchor>
          </Category>
          <Category pageMatch={isFeedbackPage}>
            <Anchor onClick={onFeedbackClick}>
              Feedback
            </Anchor>
          </Category>
          <Category pageMatch={isProfilePage}>
            <Anchor onClick={onProfileClick}>
              Profile
            </Anchor>
          </Category>
          <Category pageMatch={isCSCPage}>
            <Anchor onClick={onClientServiceCenterClick}>
              Client Service
            </Anchor>
          </Category>
        </Bundle>
