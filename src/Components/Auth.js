...
import AuthSocialLogin from "./AuthSocialLogin.js";
...
export default function Auth() {
  ...
  const contactOnClick = () => {
    Swal.fire({
      ...
      icon: "info",
      footer:
        '<a href="https://open.kakao.com/me/junhopportunity">실시간 채팅 상담</a>',
    });
  };
  ...
  return (
    <Wrapper>
      <AuthBox>
        ...
        <Question onClick={contactOnClick}>도움이 필요하신가요?</Question>
        <AuthSocialLogin />
      </AuthBox>
    </Wrapper>
  );
